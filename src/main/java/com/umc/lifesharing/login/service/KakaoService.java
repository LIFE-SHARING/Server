...
//    }
    ...
    public Jws<Claims> getUserInfo2IdTkn(String idToken) throws NoSuchAlgorithmException, InvalidKeySpecException, JsonProcessingException {
        return jwtOIDCUtil.getKidFromUnsignedTokenClaims(idToken, kakaoProperties.getIss(), kakaoProperties.getAud());
    }
