...
public class PaymentRestController {
    ...
    @PostMapping("/{userId}/{productId}/toss")
    ...
    public ApiResponse<TossPaymentReqDto> requestTossPayment(@PathVariable Long userId,@PathVariable Long productId, @RequestBody @Valid TossPaymentDto tossPaymentDto) {
        TossPaymentReqDto paymentResDto = paymentCommandService.requestTossPayment(tossPaymentDto, userId, productId).toPaymentResDto();
